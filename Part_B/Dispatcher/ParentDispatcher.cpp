...
CSemaphore Dispatch("Dispatcher_Mutex", 0, 1);		//Signal dispatcher that there is a new command
CSemaphore IO_m("IO_Mutex", 0, 1);		//Signal IO thread that Dispather is ready for another command
...
int main()
{
	...
	//	Creating Processes
	//=====================
	CProcess UserIO("E:\\Panda\\Desktop\\CPEN_333_Projects\\Assignment_1_PartB\\Assignment_1\\Debug\\IO.exe",
					NORMAL_PRIORITY_CLASS,			// priority
					OWN_WINDOW,						// process has its own window					
					ACTIVE							// process is active immediately
	);

	CProcess Elevator1("E:\\Panda\\Desktop\\CPEN_333_Projects\\Assignment_1_PartB\\Assignment_1\\Debug\\Elevator_1.exe",
		NORMAL_PRIORITY_CLASS,			// priority
		OWN_WINDOW,						// process has its own window					
		ACTIVE							// process is active immediately
	);

	CProcess Elevator2("E:\\Panda\\Desktop\\CPEN_333_Projects\\Assignment_1_PartB\\Assignment_1\\Debug\\Elevator_2.exe",
		NORMAL_PRIORITY_CLASS,			// priority
		OWN_WINDOW,						// process has its own window					
		ACTIVE							// process is active immediately
	);
	...
	while (FINISHED == FALSE)
	{
		...
		IO_m.Signal();		//Signal IO that dispather is ready for another command
	}
